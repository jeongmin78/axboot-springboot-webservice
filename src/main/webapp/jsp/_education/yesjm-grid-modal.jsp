...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/_education/yesjm-grid-modal.js' />"></script>
    </jsp:attribute>
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="horizontal">
            <ax:split-panel width="*" style="">
                ...
                <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                    ...
                    <div class="right">
                        <button type="button" class="btn btn-default" data-grid-view-01-btn="create"><i class="cqc-circle-with-plus"></i> 등록</button>
                    </div>
                </div>
