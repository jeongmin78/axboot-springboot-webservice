...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        var paramObj = $.extend({}, data, { pageSize: 5 });
    ...
    EXCEL_DOWN: function (caller, act, data) {
        ...
        frm.action = '/api/v1/_education/yesjmexcel/exceldown';
        frm.enctype = 'application/vnd.ms-excel';
        frm.submit();
    },
    ...
    EXCEL_UPLOAD: function (caller, act, data) {
        ...
        if (files.length > 0) {
            ...
            $.ajax({
                type: 'POST',
                url: '/api/v1/_education/yesjmexcel/excelupload',
                dataType: 'json',
                contentType: false,
                processData: false,
                data: data,
